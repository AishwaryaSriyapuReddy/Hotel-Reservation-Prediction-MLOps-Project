...
class DataProcessor:
    ...
    def preprocessed_data(self,df):
        try:
            ...
            logger.info("Defining numerical and categorical columns from config.yaml file")
            ...
            #Our data does not have multicollinearity, so we skip this step.
            logger.info("Doing Skewness handling")
            #Defined skewness threshold in config.yaml file
    ...
    def balance_data(self,df):
        try:
            ...
            # Creating new dataframe after smote resampling
    ...
    def save_data(self,df,file_path):
        try:
            logger.info("Saving processed data in processed folder")
            df.to_csv(file_path,index=False)
            
            logger.info(f"Data saved successfully to {file_path}")
        
        except Exception as e:
            logger.error(f"Error during Saving of processed data {e}")
    ...
    def process(self):
        try:
            ...
            logger.info("Data Prcessing completed sucessfully")
